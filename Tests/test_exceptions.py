...
class TestExceptions:
    ...
    def test_invalid_element_state_exception(self, driver):
        ...
        # Clear input field
        row_1_input_element = driver.find_element(By.ID, "edit_btn")
        row_1_input_element.click()
        ...
        row_1_save_element = driver.find_element(By.ID, "save_btn")
        row_1_save_element.click()
